...
const Banner = () => {
    return (
        <div className="container px-3 relative ">
            ...
            <div className="flex justify-between items-start pb-[88px]">
                <div className=" w-[25%] pt-[192px] space-y-5">
                    ...
                    <div className="flex items-center rounded-2xl  py-3 pl-[28px] pr-[30px] bg-[#FF494A] w-[200px] ">
                        <p className='font-rubik  font-medium   text-[16px] leading-[60px]'>View Portfolio</p>
            ...
            <div className=" " >
                <h2 className=' z-[-20]  absolute top-[580px] left-30 text-transparent opacity-60  select-none font-rajdhani font-bold text-[212.9px] leading-[244.8px] [-webkit-text-stroke-width:3px] [-webkit-text-stroke-color:black]   '>WEB DESIGN</h2>
                <h2 className=' z-[-5]  absolute top-170 left-70  font-rajdhani font-bold text-[150px] leading-[172.5px] [-webkit-text-stroke-width:3px] [-webkit-text-stroke-color:#FF494A]  text-transparent translate-y-6    '>WEB DESIGN</h2>
            </div>
        </div>
    )
}
