    ...
    return (
        <div className='container px-3 pb-[120px] '>
            <div className="flex justify-between items-center  ">
                <div className=" w-[50%] bg-[#F4F4F4] pt-[36px] px-[52px] pb-[51px] rounded-[20px] space-y-3 ">
                    <div className="flex items-center ">
                        ...
                        <div className=" py-[39px] pr-[51px] pl-[44px] ">
                            <h2 className='font-rajdhani font-bold  text-[48.1px] leading-[62.6px]'> Years Of
                                experience </h2>
                        </div>
                    </div>
                    <p className='font-rubik  font-normal text-[16px] leading-[26px]'>Business consulting consultants provide expert advice and guida the
                ...
                <div className="w-[50%] grid grid-cols-1 md:grid-cols-2 gap-8  mt-[32px]  ml-[17px]  ">
                    <div className="py-[35px] px-[17px]  border border-b-[#FF494A] border-t-[#F4F4F4] border-l-[#F4F4F4] border-r-[#FF494A] bg-[#F4F4F4] shadow-[2px_2px_0px_0px_#FF494A] space-y-1  rounded-[20px]  text-center flex flex-col justify-between items-center ">
                        <div className="flex ">
