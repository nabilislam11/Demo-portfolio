    ...
    return (
        ...
        <div className='container px-3  pb-[60px] md:pb-[120px] '>
            <div className="flex flex-col md:flex-row  justify-between  ">
                ...
                <div className=" relative  md:w-[50%] grid grid-cols-1 sm:grid-cols-2 gap-8  mt-[32px]  md:ml-[17px]">

                    <div className="float-card [animation-delay:0s] w-full max-w-[360px] mx-auto h-[158px] py-[35px] px-[5px] 
...
space-y-1 rounded-[20px] text-center flex flex-col justify-between items-center">
                    ...
                    <div className="float-card [animation-delay:1s] w-full max-w-[360px] mx-auto h-[158px] py-[35px] px-[5px] 
 md:max-w-[295px] md:h-[162px]
bg-[#F4F4F4] dark:bg-[#141414] 
...
space-y-1 rounded-[20px] text-center flex flex-col justify-between items-center ">
                    ...
                    <div className="float-card [animation-delay:2s] py-[30px] px-[15px] bg-[#F4F4F4]  space-y-1  rounded-[20px]  text-center flex flex-col  justify-between items-center  bg-[#F4F4F4] dark:bg-[#141414] bg-[#F4F4F4] ">
                        <svg
                            className="absolute inset-0 w-full h-full"
                            viewBox="0 0 100 100"
                            preserveAspectRatio="none"
                    ...
                    <div className=" float-card [animation-delay:4s] py-[30px] px-[15px] bg-[#F4F4F4]  dark:bg-[#141414] space-y-1  rounded-[20px]  text-center flex flex-col  justify-between items-center  bg-[#F4F4F4] bg-[#F4F4F4] ">
