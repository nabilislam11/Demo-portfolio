        ...
        <div className='container px-3 pb-[120px] '>
            <div className="flex justify-between items-center  ">
                ...
                <div className="w-[50%] grid grid-cols-1 md:grid-cols-2 gap-8  mt-[32px]  ml-[17px]  ">
                    ...
                    <div className="py-[30px] px-[15px] bg-[#F4F4F4]  space-y-1  rounded-[20px]  text-center flex flex-col  justify-between items-center  dark:bg-[#141414]  border border-b-[#FF494A] border-t-[#F4F4F4] border-l-[#F4F4F4] border-r-[#FF494A] bg-[#F4F4F4] shadow-[2px_2px_0px_0px_#FF494A] bg-[#F4F4F4]">
                        <div className="flex text-black dark:text-white ">
