            ...
            <div className=" pt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[17px] ">
                <div className=" rounded-[20px] border border-[#D9DDE0]">
                    ...
                    <div className="p-[30px] flex flex-col gap-7.5 ">
                        <p className='font-bold font-rajdhani text-[24px] leading-[30px] text-[#141414]'>Let’s bring your ideas to life!
                            Contact me, and let’s</p>
                        <div className=" flex items-center gap-1">
                            <p className='font-normal font-rubik text-[13px] leading-[27px] text-[#5D65705D6570]'>Read More </p>
