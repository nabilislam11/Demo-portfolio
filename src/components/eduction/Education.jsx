...
const Education = () => {
    return (
        <div className=' container pt-[30px] md:pt-[120px] px-[15px]'>
            <div className="flex flex-col gap-[2px] ">
                <h2 className=' font-bold font-rajdhani text-[32px] text-[#141414] dark:text-white leading-[42px] '>Education</h2>
                <div className=" grid grid-cols-1 md:grid-cols-2  gap-2 md:gap-8">
                    <div className=" mt-[20px] md:mt-[32px]  flex flex-col  justify-between items-center gap-5 ">
