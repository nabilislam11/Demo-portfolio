            ...
            <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col md:flex-row items-center mx-auto gap-1.5 md:gap-3.5">
                    <div className="md:mt-[30px] p-[20px] md:p-[38px]  rounded-[20px] bg-[#F4F4F4] dark:bg-[#141414] flex flex-col gap-0.5 ">
                        ...
                        <div className="flex flex-col  gap-[17px] pt-[20px] md:pt-[43px] pb-[20px] md:pb-[38px] ">
                            <div className=" flex items-center gap-2.5 py-[2px] md:w-[325px]  ">
                    ...
                    <div className="mt-[30px] p-[20px] md:p-[38px]  rounded-[20px] bg-[#F4F4F4] dark:bg-[#141414] flex flex-col gap-0.5 ">
                        <p className='font-bold  font-rajdhani text-[18px] leading-[27px] text-[#141414] dark:text-white'>Starter</p>
                        <h1 className='font-bold  font-rajdhani text-[20px] md:text-[48px] leading-7  md:leading-[60px] text-[#141414] dark:text-white'>$ 5.00</h1>
                    ...
                    <div className="mt-[30px] p-[20px] md:p-[38px]  rounded-[20px] bg-[#F4F4F4] dark:bg-[#141414] flex flex-col gap-0.5 ">
                        <p className='font-bold  font-rajdhani text-[18px] leading-[27px] text-[#141414] dark:text-white'>Starter</p>
                        <h1 className='font-bold  font-rajdhani text-[20xp] md:text-[48px] leading-7 md:leading-[60px] text-[#141414] dark:text-white'>$ 5.00</h1>
                        <p className='font-bold  font-rajdhani text-[18px] leading-[27px] text-[#141414] dark:text-white pt-[3px] pb-[26px] '>Per Month</p>
                        <div className="flex flex-col  gap-[17px] pt-[20px] md:pt-[43px] pb-[20px] md:pb-[38px] ">
                            <div className="md:w-[325px]  flex items-center gap-2.5 py-[2px]  ">
                                <IoCheckmarkCircle className='text-red-500 ' />
                                <p className='font-normal  font-rubik  text-[16px] leading-[24px] text-[#5D6570] dark:text-[#9F9F9F]'>5 Social Media Account</p>
                            </div>
                            <div className=" flex gap-2.5 py-[2px]  ">
